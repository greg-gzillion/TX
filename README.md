# Phoenix PME - TX Blockchain Integration
...
- Built for TX blockchain (Coreum/Sologenic merger), compatible with upcoming tx (Coreum + Sologenic)
...
## 🪙 TESTUSD Token - Live on TX (Coreum/Sologenic) Testnet
...
### License
This project is dual-licensed. See `docs/legal/DUAL_LICENSE.md` for details.

### Contributor Agreement
All contributors must agree to the terms in `docs/legal/CONTRIBUTOR_AGREEMENT.md`.

### Original Repository
This is a reorganized version of the original project at:
https://github.com/PhoenixPME/coreum-pme

All legal documents have been transferred and remain in effect.
