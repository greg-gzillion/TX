...
export const coinReferences: Record<string, CoinReference> = {
  'Morgan Silver Dollar': {
    ...
    ngcUrl: 'https://www.ngccoin.com/coin-explorer/united-states/morgan-dollars',
  ...
  'Saint-Gaudens Gold $20': {
    pcgsUrl: 'https://www.pcgs.com/coinfacts/category/saint-gaudens-double-eagles',
    ngcUrl: 'https://www.ngccoin.com/coin-explorer/united-states/saint-gaudens-double-eagles',
  ...
  'Lincoln Wheat Cent': {
    pcgsUrl: 'https://www.pcgs.com/coinfacts/category/lincoln-cents-wheat-reverse',
    ngcUrl: 'https://www.ngccoin.com/coin-explorer/united-states/lincoln-cents-wheat-reverse',
    notes: '1909-S VDB is key date with only 484,000 minted.'
  },
  'Buffalo Nickel': {
    pcgsUrl: 'https://www.pcgs.com/coinfacts/category/buffalo-nickels',
    ngcUrl: 'https://www.ngccoin.com/coin-explorer/united-states/buffalo-nickels',
    notes: '1913-S Type 2 is key date.'
  },
  'Standing Liberty Quarter': {
    pcgsUrl: 'https://www.pcgs.com/coinfacts/category/standing-liberty-quarters',
    ngcUrl: 'https://www.ngccoin.com/coin-explorer/united-states/standing-liberty-quarters',
    notes: '1916 is key date with only 52,000 minted.'
  },
  'Walking Liberty Half Dollar': {
    pcgsUrl: 'https://www.pcgs.com/coinfacts/category/walking-liberty-half-dollars',
    ngcUrl: 'https://www.ngccoin.com/coin-explorer/united-states/walking-liberty-half-dollars',
