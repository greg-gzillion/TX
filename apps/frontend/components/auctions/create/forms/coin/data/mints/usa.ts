...
export const usaMints: Record<string, MintData[]> = {
  ...
  'Platinum': [
    { value: 'Philadelphia (P) - 1792-present', label: '🇺🇸 Philadelphia (P) - 1792-present', minYear: 1997, maxYear: 'present' },
    { value: 'West Point (W) - 1988-present', label: '🇺🇸 West Point (W) - 1988-present', minYear: 1997, maxYear: 'present' },
  ],
  'Palladium': [
    { value: 'West Point (W) - 1988-present', label: '🇺🇸 West Point (W) - 1988-present', minYear: 2017, maxYear: 'present' },
  ],
  'Copper': [
    { value: 'Philadelphia (P) - 1792-present', label: '🇺🇸 Philadelphia (P) - 1792-present', minYear: 1792, maxYear: 'present' },
    { value: 'Denver (D) - 1906-present', label: '🇺🇸 Denver (D) - 1906-present', minYear: 1906, maxYear: 'present' },
