      ...
      <div className="max-w-2xl mx-auto">
        ...
        {fetchError && (
          <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
            ...
            <p className="text-sm text-red-700 mt-1">
              Unable to connect to backend. This is likely a CORS issue. Make
              sure your backend allows requests from this domain.
            </p>
          </div>
        )}
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="p-3 bg-gray-50 rounded">
                🥇 Gold:{" "}
                <span className="font-bold">${currentPrices.gold}</span>
              </div>
              <div className="p-3 bg-gray-50 rounded">
                🥈 Silver:{" "}
                <span className="font-bold">${currentPrices.silver}</span>
              </div>
              <div className="p-3 bg-gray-50 rounded">
                🔷 Platinum:{" "}
                <span className="font-bold">${currentPrices.platinum}</span>
              </div>
              <div className="p-3 bg-gray-50 rounded">
                🔶 Palladium:{" "}
                <span className="font-bold">${currentPrices.palladium}</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormPrices({ ...formPrices, gold: e.target.value })
                  }
                  className="w-full p-2 border rounded focus:ring-2 focus:ring-amber-500 focus:border-amber-500"
                  placeholder="5230.30"
                  required
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormPrices({ ...formPrices, silver: e.target.value })
                  }
                  className="w-full p-2 border rounded focus:ring-2 focus:ring-amber-500 focus:border-amber-500"
                  placeholder="87.83"
                  required
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormPrices({ ...formPrices, platinum: e.target.value })
                  }
                  className="w-full p-2 border rounded focus:ring-2 focus:ring-amber-500 focus:border-amber-500"
                  placeholder="2145"
                  required
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormPrices({ ...formPrices, palladium: e.target.value })
                  }
                  className="w-full p-2 border rounded focus:ring-2 focus:ring-amber-500 focus:border-amber-500"
                  placeholder="1717"
                  required
        ...
        <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
          ...
          <p className="text-xs text-blue-700">
            These reference prices are updated manually by the admin. Metal
            prices fluctuate constantly during market hours. The prices shown
            are a snapshot at the time of last update and may not reflect
            current market conditions.
          </p>
          <p className="text-xs text-blue-600 mt-2">
            Last manual update:{" "}
            {currentPrices
              ? new Date(currentPrices.createdAt).toLocaleString()
              : "Never"}
          </p>
        </div>
