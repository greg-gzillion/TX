      ...
      <div className="bg-red-100 border-b-4 border-red-600">
        <div className="max-w-7xl mx-auto px-4 py-3">
          <p className="text-red-800 text-center flex items-center justify-center gap-2">
            ...
            All transactions are on testnet. Do not send real funds. For testing
            only.
            <span className="text-xl">⚠️</span>
          </p>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 text-lg">
            Experiment with auctions, test smart contracts, and explore the
            platform. All tokens are testnet only -{" "}
            <span className="font-semibold text-red-600">no real value</span>.
          </p>
        </div>
        ...
        <div
          key="price-feed"
          className="mb-8 transform hover:scale-102 transition-transform"
        >
          <PriceFeed />
        </div>
          ...
          {selectedWallet ? (
            ...
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl shadow-lg p-12 text-center border-2 border-dashed border-blue-200">
              ...
              <p className="text-gray-500 max-w-md mx-auto">
                Choose a wallet from the panels above to start testing auctions
                and smart contracts
              </p>
            </div>
          )}
