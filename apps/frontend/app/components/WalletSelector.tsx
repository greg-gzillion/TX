...
const ALL_WALLETS = [
  { id: 'keplr', name: 'Keplr Wallet', icon: '🔷', description: 'Osmosis Recommended', recommended: true },
  { id: 'leap', name: 'Leap Wallet', icon: '🦘', description: 'Cosmos (Osmosis issues)', disabled: true },
    ...
    <div className="space-y-6">
      <div className="bg-white p-6 rounded-xl border shadow-sm">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-semibold text-gray-900">Connect to Osmosis Testnet</h3>
        ...
        {!isConnected ? (
          <div className="space-y-4">
            <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
              <p className="text-blue-800 font-medium">💡 Use Keplr for Osmosis Testnet</p>
              <p className="text-blue-600 text-sm mt-1">
                Keplr has built-in Osmosis support. Install from{' '}
            ...
            <div className="text-sm text-gray-500 text-center">
              <p>Make sure Keplr is installed and you're logged into Osmosis Testnet</p>
            </div>
          </div>
        ) : (
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="p-4 bg-gray-50 rounded-lg">
                ...
                <p className="font-medium">Osmosis Testnet</p>
              </div>
              <div className="p-4 bg-gray-50 rounded-lg">
        ...
        {phase7Active && (
          <div className="mt-4 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg">
            ...
            <ol className="text-sm text-blue-700 space-y-2 ml-4 list-decimal">
              <li>Keplr connected to Osmosis testnet ✓</li>
